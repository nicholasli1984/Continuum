    ...
    const TopNav = () => (
      <nav style={{
        ...
        <button onClick={() => { goTo("landing"); }} style={{ background: "none", border: "none", cursor: "pointer", flexShrink: 0, padding: 0 }}>
          <img src="/ContinuumLogo.png" alt="Continuum" style={{ height: 56, display: "block" }} />
        </button>
        ...
        <div style={{ maxWidth: 1060, margin: "0 auto", display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 48 }}>
          <div style={{ maxWidth: 320 }}>
            <div style={{ marginBottom: 16 }}>
              <img src="/ContinuumLogo.png" alt="Continuum" style={{ height: 60, display: "block" }} />
            </div>
          ...
          {!cockpitSection ? (
            <div style={{ position: "relative", width: "100vw", height: "100vh", overflow: "hidden" }}>
              ...
              <div style={{ position: "absolute", top: 12, left: 16, zIndex: 20 }}>
                <img src="/ContinuumLogo.png" alt="Continuum" style={{ height: 80, display: "block" }} />
              </div>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "calc(100vh - 200px)", padding: "36px 20px" }}>
          <div style={{
            ...
            <div style={{ textAlign: "center", marginBottom: 32 }}>
              <div style={{ display: "flex", justifyContent: "center", marginBottom: 10 }}><img src="/ContinuumLogo.png" alt="Continuum" style={{ height: 110, display: "block" }} /></div>
  ...
  const renderPremium = () => (
    <div>
      <div style={{ textAlign: "center", marginBottom: 40 }}>
        <div style={{ marginBottom: 12, display: "flex", justifyContent: "center" }}><img src="/ContinuumLogo.png" alt="Continuum" style={{ height: 120, display: "block" }} /></div>
    ...
    <div style={{
      ...
      <aside style={{
        ...
        <div style={{ padding: "0 8px", marginBottom: 28 }}>
          <img src="/ContinuumLogo.png" alt="Continuum" style={{ height: 70, display: "block" }} />
        </div>
      ...
      {showUpgrade && (
        <div style={{
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            <div style={{ marginBottom: 12, display: "flex", justifyContent: "center" }}><img src="/ContinuumLogo.png" alt="Continuum" style={{ height: 110, display: "block" }} /></div>
