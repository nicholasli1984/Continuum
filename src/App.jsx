          ...
          >
            ...
            >
              ...
              {/* Social sign-in. On native (Capacitor) we use the OS-native
                  ...
                  that's what failed App Store Guideline 4 the first time), no
                  Magic Link. On web/PWA we keep the signInWithOAuth redirect
                  flow (fine in a browser) plus Magic Link. */}
              {(() => {
