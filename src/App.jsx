        ...
        {loginModalOpen && (
          ...
          >
            ...
            >
              ...
              {/* Social buttons — hidden on Capacitor native because Apple/Google/Magic
                  Link all redirect through the system browser, which fails App Store
                  Guideline 4 (poor UX from leaving the app). Email + password works
                  identically in-app on both web and native. */}
              {!isNative() && (
                <>
