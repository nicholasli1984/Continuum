...
export const AIRLINE_TERMINAL_AT_AIRPORT = {
  ...
  CLO: {
    avianca: ["national","international"],
    latam: ["national","international"],
    copa: ["international"],
    ua: ["international"],
    sw: ["international"],
    aa: ["international"],
  ...
  CNX: {
    thai: ["Domestic","International"],
    airasia: ["International","Domestic"],
  },
  COK: {
    air_india: ["1","3"],
    emirates_skywards: ["3"],
  ...
  CTG: {
    avianca: ["domestic","international"],
    latam: ["domestic","international"],
    copa: ["international"],
    aa: ["international"],
    b6: ["international"],
  },
  CTS: {
    ana: ["Domestic","International"],
    jal: ["Domestic","International"],
  },
  CTU: {
    air_china: ["1","2"],
    china_eastern: ["2"],
  ...
  DAC: {
    emirates_skywards: ["International"],
    qatar: ["International"],
    singapore_kf: ["International"],
    thai: ["International"],
    etihad_guest: ["International"],
  },
  DAD: {
    vietnam_air: ["1","2"],
    airasia: ["2"],
  ...
  GMP: {
    korean_air: ["Domestic","International"],
    asiana: ["Domestic","International"],
  },
  GOT: {
    sas: ["1"],
    lufthansa: ["1"],
  ...
  GYE: {
    latam: ["international","domestic"],
    avianca: ["international","domestic"],
    copa: ["international"],
    b6: ["international"],
    aa: ["international"],
  },
  ...
  KHH: {
    eva_air: ["International"],
    cathay_mp: ["International"],
    scoot: ["International"],
  },
  KHI: {
    emirates_skywards: ["International"],
  ...
  MAA: {
    air_india: ["Domestic","International"],
    emirates_skywards: ["International"],
    singapore_kf: ["International"],
    qatar: ["International"],
  ...
  DMM: {
    flynas: ["International","Domestic"],
    saudia: ["International","Domestic"],
    gulf_air: ["International"],
    emirates_skywards: ["International"],
    qatar: ["International"],
  },
  DUR: {
  ...
  AUS: {
    ...
    dl: ["E"],
    ua: ["E"],
    sw: ["E"],                   // South Terminal closed 2023; SW now in main (Barbara Jordan)
    atmos: ["E"],
    ba_avios: ["E"],
    aeroplan: ["E"],
  },
